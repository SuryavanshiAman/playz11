...
import 'package:playz11/view/widgets/players_details_page.dart';
          ...
          children: [
            InkWell(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PlayersListPage(index: "0", player1:null ,player2 : wK)),
                ):Utils.showErrorMessage(context, 'Player points  updated only the after the match start');
              },
                      ...
                      Positioned(
                        ...
                        child: ContainerConst(
                          ...
                          child: TextConst(
                            ...
                            textColor: widget.data.homeTeamid.toString() != wK.teamid.toString()
                                ? AppColor.whiteColor
                                : AppColor.textGreyColor,
