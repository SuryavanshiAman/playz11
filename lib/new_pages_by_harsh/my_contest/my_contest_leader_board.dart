...
class _MyContestLeaderBoardState extends State<MyContestLeaderBoard> {
  ...
  Widget build(BuildContext context) {
    return matchingUserItems.isEmpty?const Center(child: CircularProgressIndicator()):
    RefreshIndicator(
      color: Colors.white,
  ...
  Widget _buildLeaderBoardList(
    ...
    return items.isEmpty?const Center(child: CircularProgressIndicator()):
      ListView.builder(
      shrinkWrap: true,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        data.matchstatus == 3
                            ...
                            : TextConst(
                                text: data.winingZone != null&&data.winingZone=="1"
                                    ? "Winning Zone"
                                    : '',
                                fontSize: Sizes.fontSizeOne,
                                textColor: AppColor.activeButtonGreenColor,
  ...
  Future<void> myContestLeaderBoardApi() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('${AppApiUrls.getLiveMatchLeaderBoard}$teamId/$contestId'),
      );
