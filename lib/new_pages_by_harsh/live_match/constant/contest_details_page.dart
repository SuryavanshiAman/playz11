          ...
          Padding(
            ...
            child: LinearProgressIndicator(
              value: (int.parse(widget.contestList.totalSpot.toString()) -
                      double.parse(widget.contestList.left_spot.toString())) /
            ...
            //   value:
            //   (int.parse(contest.totalSpot==""?"50":contest.totalSpot.toString()) - 10) / int.parse(contest.totalSpot==""?"50":contest.totalSpot.toString()),
            //   backgroundColor: Colors.grey.shade300,
            //   valueColor: const AlwaysStoppedAnimation<Color>(Colors.red),
            // ),
          ),
