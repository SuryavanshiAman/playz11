  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PlayerViewModel>(builder: (context, pvmCon, child) {
      ...
      final teamOneAnnounced =
          teamOne.where((e) => e.playigstatus.toString() == '1').toList();
      final teamOneUnannounced =
          teamOne.where((e) => e.playigstatus.toString() == '2').toList();

      final teamTwoAnnounced =
          teamTwo.where((e) => e.playigstatus.toString() == '1').toList();
      final teamTwoUnannounced =
          teamTwo.where((e) => e.playigstatus.toString() == '2').toList();


      final teamOnePlayedLastMatch = teamOne
          .where((e) =>
      e.playigstatus.toString() == '0' && e.played_last_match.toString() == '1')
          .toList();

      final teamOneOtherTeam = teamOne
          .where((e) =>
      e.playigstatus.toString() == '0' && e.played_last_match.toString() == '0')
          .toList();
