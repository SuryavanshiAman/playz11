          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: ContainerConst(
                ...
                color:isSelected?AppColor.focusedLanguageBoxBgColor:const Color(0xff3d1414),
                child: ListTile(
                  ...
                  title: TextConst(text: languageName,alignment: FractionalOffset.centerLeft,fontWeight: FontWeight.w600,fontSize: Sizes.fontSizeTwo,textColor: AppColor.whiteColor,),
                  onTap: () {
