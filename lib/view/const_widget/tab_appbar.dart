...
// import 'package:playz11/view/widgets/circular_profile_image_widget.dart';
//
...
//
//   Widget tabBarDesign(context, GameViewModel gameProvider) {
...
//             gameProvider.setSelectedGameTabIndex(tabIndex);
//           },
//           tabs: List.generate(
...
//   }
//
//   Widget appBarActionsForHomeScreen(context) {
//     return Row(
//       children: [
//         InkWell(
//           onTap: () {
...
//                     if(notificationCon.notificationData == null){
//                       return const SizedBox.shrink();
//                     }else {
//                       return int.parse(notificationCon.notificationData.counts
//                           .toString()) >
//                           0
//                           ? ContainerConst(
...
//                         child: Text(
//                           "${notificationCon.notificationData.counts}",
//                           style: TextStyle(
