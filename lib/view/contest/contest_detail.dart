...
import 'package:playz11/view/contest/joiin_contest_bottom_sheet.dart';
import 'package:playz11/view/widgets/contest_leader_board.dart';
import 'package:provider/provider.dart';
import 'package:playz11/utils/route/app_routes.dart';
import 'package:playz11/view/widgets/contest_winners_list.dart';
...
class ContestDetailScreen extends StatefulWidget {
  ...
  const ContestDetailScreen({super.key, required this.args});
...
class _ContestDetailScreenState extends State<ContestDetailScreen>
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    TextConst(
                      text: contestData.left_spot == 0
                          ? 'full'
                          : "${contestData.left_spot.toString()} spots left",
                      width: Sizes.screenWidth / 2.5,
                      alignment: Alignment.centerLeft,
              ...
              Sizes.spaceHeight5,
              _buildJoinButton(contestData, context, contestProvider),
              Sizes.spaceHeight10,
              Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      ContainerConst(
                        ...
                        child: TextConst(
                          text: contestData.entry_limit == 'Single' ? 'S' : 'M',
                      ...
                      Sizes.spaceWidth5,
                      TextConst(
                        text: contestData.entry_limit ?? "0",
                        fontSize: Sizes.fontSizeOne,
                        textColor: AppColor.textGreyColor,
                      ),
                      const Spacer(),
                      TextConst(
                        text:
                            contestData.contest_success_type ?? "Not available",
  ...
  Future<void> _joinContestLogic(BuildContext context, contestData,
    ...
    //
    // await playerViewModel.getPlayers(context);
    //
    // if (playerViewModel.teamData?.data?.isEmpty ?? true) {
    //   WidgetsBinding.instance.addPostFrameCallback((_) {
    //     playerViewModel.clearSelectedPlayerList();
    //   });
