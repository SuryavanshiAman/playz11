...
import 'package:playz11/view/bottom_navigation/home_section/home_slider_screen.dart';
import 'package:playz11/view/const_widget/container_const.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';
import 'package:playz11/view/widgets/upcoming_matches.dart';
...
class HomePageTabDataState extends State<HomePageTabData> {
  ...
  Widget myMatchSlider(GameViewModel gameProvider) {
    ...
    // Return an empty widget if no matches
    if (myMatchData.isEmpty) {
      return const SizedBox.shrink();
    }

    // Sorting matches: upcoming (1), live (2), completed (3)
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                              TextConst(
                                text:
                                    "${data.total_joined_team} Team • ${data.total_joined_contest} Contest",
