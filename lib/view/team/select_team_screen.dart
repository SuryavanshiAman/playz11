...
class _SelectTeamScreenState extends State<SelectTeamScreen> {
  ...
  Widget avlTeamList() {
    return Consumer<PlayerViewModel>(builder: (context, pvmCon, child) {
      ...
      final joinedTeams = pvmCon.teamData!.data!.where((team) => team.joinedStatus.toString() == '1').toList();
      final otherTeams = pvmCon.teamData!.data!.where((team) => team.joinedStatus.toString() != '1').toList();
      print(joinedTeams.length);
      print('joinedTeams.length');
      print(otherTeams.length);
      print('otherTeams.length');
      ...
      return ListView(
        ...
        children: [
                                  ...
                                  children: [
                                    ContainerConst(
                                      ...
                                      image: const DecorationImage(
                                          image:
                                              AssetImage(Assets.assetsFieldGrass),
                                          fit: BoxFit.cover),
                                      child: Column(
                                        children: [
                                          ContainerConst(
          ...
          joinedTeams.length==0?SizedBox.shrink():
          Padding(
            padding: const EdgeInsets.all(8.0),
  ...
  Widget joinButton() {
    return Consumer<PlayerViewModel>(builder: (context, pvmCon, _) {
      // Ensure pvmCon.teamData and pvmCon.selectedTeam are not null before accessing them
      final teamData = pvmCon.teamData?.data;
      final selectedTeam = pvmCon.selectedTeam;
          ...
          children: [
            Column(
              ...
              children: [
                ...
                TextConst(
                  alignment: Alignment.centerLeft,
                  text: selectedTeam != null && teamData != null
                      ? "Team ${(teamData.indexWhere((e) => e.id == selectedTeam.id) + 1)}"
                      : "Team not selected",
                  width: 120,
                  fontWeight: FontWeight.w600,
                  fontSize: selectedTeam != null && teamData != null?14:10,
                ),
              ],
            ),
            ButtonConst(
              onTap: () {selectedTeam != null && teamData != null?
              ...
              width: 100,
              color: selectedTeam != null && teamData != null?AppColor.activeButtonGreenColor:AppColor.textGreyColor,
              textColor: AppColor.whiteColor,
            ),
          ],
        ),
