...
import 'package:playz11/view/team/team_preview_screen.dart';
import 'package:playz11/view/widgets/players_listing.dart';
    ...
    return Consumer2<PlayerViewModel, GameViewModel>(
      builder: (context, playerProvider, gameProvider, child) {
        ...
        final team1PlayerCount = playerProvider.selectedPlayers
            .where(
                (e) => e.teamId == teamIds[1]) // Assuming teamIds[1] is Team 1
            .length;
        final team2PlayerCount = playerProvider.selectedPlayers
            .where(
                (e) => e.teamId == teamIds[0]) // Assuming teamIds[0] is Team 2
            .length;
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ButtonConst(
                      onTap: () {
                        Navigator.pushNamed(
                            context, AppRoutes.pastLineUpScreen);
                      },
