...
class GameData {
  ...
  dynamic isLineUp;
  dynamic megaContest;
  dynamic total_joined_contest;
  dynamic total_joined_team;
  ...
  GameData(
      {this.id,
        ...
        this.isLineUp,
        this.megaContest,
        this.total_joined_contest,
        this.total_joined_team,
        this.totalWinnings,
        this.note,
        this.homeTeamScore,
        this.homeTeamWicket,
  ...
  GameData.fromJson(Map<String, dynamic> json) {
    ...
    total_joined_contest = json['total_joined_contest'];
    total_joined_team = json['total_joined_team'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['total_joined_contest'] = total_joined_contest;
    data['total_joined_team'] = total_joined_team;
