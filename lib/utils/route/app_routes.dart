...
import 'package:playz11/res/sliding_animation.dart';
import 'package:playz11/view/auth/login_screen.dart';
import 'package:playz11/view/auth/other_login_screen.dart';
import 'package:playz11/view/auth/otp_screen.dart';
import 'package:playz11/view/auth/register_screen.dart';
import 'package:playz11/view/contest/contest_detail.dart';
import 'package:playz11/view/contest/contest_screen.dart';
import 'package:playz11/view/drawer/how_to_play/how_to_play_game_type_screen.dart';
import 'package:playz11/view/drawer/how_to_play/how_to_play_screen.dart';
import 'package:playz11/view/drawer/info_setting/app_setting_language.dart';
import 'package:playz11/view/drawer/info_setting/view_profile_screen.dart';
import 'package:playz11/view/home_screen.dart';
import 'package:playz11/view/initial_pages/intro_screen.dart';
import 'package:playz11/view/initial_pages/language_screen.dart';
import 'package:playz11/view/mlm/customer_service_screen.dart';
import 'package:playz11/view/mlm/invitation_rules_screen.dart';
import 'package:playz11/view/mlm/new_subordinate_screen.dart';
import 'package:playz11/view/mlm/promotion_screen.dart';
import 'package:playz11/view/mlm/referral_list_screen.dart';
import 'package:playz11/view/mlm/sub_ordinate_screen.dart';
import 'package:playz11/view/notification/notification_screen.dart';
import 'package:playz11/view/initial_pages/splash_screen.dart';
import 'package:playz11/view/team/choose_c_vc_screen.dart';
import 'package:playz11/view/team/create_team_screen.dart';
import 'package:playz11/view/team/past_lineup_screen.dart';
import 'package:playz11/view/team/select_team_screen.dart';
import 'package:playz11/view/wallet/add_bank_account_screen.dart';
import 'package:playz11/view/wallet/add_cash_screen.dart';
import 'package:playz11/view/wallet/my_balance_screen.dart';
import 'package:playz11/view/wallet/my_transactions_screen.dart';
import 'package:playz11/view/wallet/picked_image_view_screen.dart';
import 'package:playz11/view/wallet/verify_details.dart';
import 'package:playz11/view/wallet/withdraw_cash_screen.dart';
  ...
  static Route<dynamic>? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case contestDetailScreen:
        final args = settings.arguments as Map<String, dynamic>;
        return CustomSlidePageRoute(page: ContestDetailScreen(args: args));
