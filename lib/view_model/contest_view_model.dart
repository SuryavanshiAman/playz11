...
// import 'package:playz11/model/match_type_model.dart';
// import 'package:playz11/repo/contest_repo.dart';
...
import 'package:playz11/view/bottom_navigation/my_match_section/bottom_nav_my_match_screen.dart';
import 'package:provider/provider.dart';
import 'package:playz11/model/contest_data_model.dart';
import 'package:playz11/model/match_type_model.dart';
import 'package:playz11/repo/contest_repo.dart';
...
class ContestViewModel with ChangeNotifier {
  ...
  Future<void> joinContest(BuildContext context) async {
    final data = {
      ...
      'amount': Provider.of<ContestViewModel>(context, listen: false).selectedContestData!.entryFee.toString(),
