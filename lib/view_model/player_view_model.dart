...
import 'package:playz11/model/player_data_insert_model.dart';
import 'package:playz11/model/player_data_model.dart';
import 'package:playz11/model/player_designation_model.dart';
import 'package:playz11/model/team_data_model.dart';
import 'package:playz11/repo/player_repo.dart';
...
class PlayerViewModel with ChangeNotifier {
  ...
  void togglePlayerSelection(int index) {
    print("ghcghchcgc");
    print(_playerData!.data![index].designationId);
    print(_playerData!.data![index].designationName);
    print(_playerData!.data![index].teamId);
  ...
  Future<void> getTeam(
    ...
    try {
      ...
      print("team payload : $data");
      if (_teamData!.status == "200") {
        if (_teamData!.data!.isNotEmpty) {
          Provider.of<PlayerViewModel>(context ,listen: false).teamData!.data!.length==1? setSelectedTeam(_teamData!.data![0]):null;
        }
        notifyListeners();
      } else {
